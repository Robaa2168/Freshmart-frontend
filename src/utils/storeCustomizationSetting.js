const storeCustomization = {
  setting: {
    ...
    home: {
      ...
      discount_coupon_code: ["BFRIDAY", "JANUARY"],
      place_holder_img: "",
    ...
    contact_us: {
      ...
      address_box_address_two: {
        en: "Stall No. 14, Ground Floor, City Market ",
        de: "Stall No. 14, Ground Floor, City Market",
      },
    ...
    slug: {
      ...
      card_description_one: {
        en: "Free shipping applies to all orders over shipping KES 1500",
